...
class RidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rider" do
    assert_difference("Rider.count") do
      post riders_url, params: { rider: { city_of_origin: @rider.city_of_origin, first_name: @rider.first_name, last_name: @rider.last_name, placeholder: @rider.placeholder, state_of_origin: @rider.state_of_origin } }
    end
  ...
  test "should update rider" do
    patch rider_url(@rider), params: { rider: { city_of_origin: @rider.city_of_origin, first_name: @rider.first_name, last_name: @rider.last_name, placeholder: @rider.placeholder, state_of_origin: @rider.state_of_origin } }
